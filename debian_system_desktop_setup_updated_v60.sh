...
show_menu() {
  clear
  echo -e "${BOLD}${CYAN}LMDE / Ubuntu / Zorin Interactive Setup Script v60${NC}"
  echo -e "${CYAN}Log file         : ${LOG_FILE}${NC}"
  echo -e "${CYAN}Report file      : ${REPORT_FILE}${NC}"
  ...
  echo "14) Build profiles / Guided setup"
  echo "15) State tracking / Install history"
  echo "16) Backup before major changes"
  echo "17) Ansible export mode"
  echo "18) Dotfiles / Settings Sync"
  echo "19) Exit"
  echo
}
...
main() {
  ...
  while true; do
    ...
    case "$choice" in
      ...
      14) handle_profiles_menu ;;
      15) run_registered_section 34; press_enter ;;
      16) run_registered_section 35; press_enter ;;
      17) run_registered_section 36; press_enter ;;
      18) run_registered_section 37; press_enter ;;
      19) success "Exiting."; exit 0 ;;
      *) warn "Invalid selection."; press_enter ;;
    esac
  done
}
