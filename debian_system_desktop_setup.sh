...
section_6_set_monospace_font() {
  ...
  set_gsetting_if_supported org.cinnamon.desktop.interface monospace-font-name "'MesloLGS Nerd Font Regular 14'"
  set_gsetting_if_supported org.gnome.desktop.interface monospace-font-name "'MesloLGS Nerd Font Regular 14'"

  info "Verification:"
  echo "  Cinnamon monospace: $(get_gsetting_if_available org.cinnamon.desktop.interface monospace-font-name)"
  echo "  GNOME monospace   : $(get_gsetting_if_available org.gnome.desktop.interface monospace-font-name)"

  warn "If your terminal profile overrides the system font, set the profile font manually."
}
